...
module.exports = (env) => {
  ...
  const publicPath = isProduction ? 'https://erikvullings.github.io/test_ziekenhuizen/' : '/';
    ...
    plugins: [
      ...
      new HtmlWebpackTagsPlugin({
        metas: [
          ...
          {
            attributes: { property: 'og:url', content: 'https://erikvullings.github.io/test_ziekenhuizen' },
          },
          // {
