...
export const ziekenhuisGeojson = path.resolve(__dirname, '../../gui/src/assets', 'ziekenhuizen.geojson');
export const aanrijdGeojson25 = path.resolve(__dirname, '../../gui/src/assets', 'aanrijden25.geojson');
export const aanrijdGeojson30 = path.resolve(__dirname, '../../gui/src/assets', 'aanrijden30.geojson');
